...
class AnalisisController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $analises = $em->getRepository('PacienteBundle:Analisis')->findAll();
    ...
    {
        $analisi = new Analisi();
        $form = $this->createForm('PacienteBundle\Form\AnalisisType', $analisi);
    ...
    {
        $deleteForm = $this->createDeleteForm($analisi);
        $editForm = $this->createForm('PacienteBundle\Form\AnalisisType', $analisi);
